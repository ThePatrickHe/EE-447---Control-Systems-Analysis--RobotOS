...
class led_msg {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.occupied_channel = null;
      this.r = null;
      this.g = null;
      this.b = null;
    }
    else {
      if (initObj.hasOwnProperty('occupied_channel')) {
        this.occupied_channel = initObj.occupied_channel
      }
      else {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [occupied_channel]
    bufferOffset = _serializer.int32(obj.occupied_channel, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [occupied_channel]
    data.occupied_channel = _deserializer.int32(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.occupied_channel !== undefined) {
      resolved.occupied_channel = msg.occupied_channel;
    }
    else {
      resolved.occupied_channel = 0
    }
