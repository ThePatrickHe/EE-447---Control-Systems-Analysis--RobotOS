...
(cl:defclass <led_msg> (roslisp-msg-protocol:ros-message)
  ((occupied_channel
    :reader occupied_channel
    :initarg :occupied_channel
    :type cl:integer
    :initform 0)
   (r
    :reader r
...
(cl:ensure-generic-function 'occupied_channel-val :lambda-list '(m))
(cl:defmethod occupied_channel-val ((m <led_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader freenove_base-msg:occupied_channel-val is deprecated.  Use freenove_base-msg:occupied_channel instead.")
  (occupied_channel m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <led_msg>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'occupied_channel)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 4294967296) signed)))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <led_msg>) istream)
  "Deserializes a message object of type '<led_msg>"
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:slot-value msg 'occupied_channel) (cl:if (cl:< unsigned 2147483648) unsigned (cl:- unsigned 4294967296))))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<led_msg>)))
  ...
  "0d557764c30ab24fea6db8ccf3b5bbbd")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'led_msg)))
  "Returns md5sum for a message object of type 'led_msg"
  "0d557764c30ab24fea6db8ccf3b5bbbd")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<led_msg>)))
  ...
  (cl:format cl:nil "int32 occupied_channel~%int32 r~%int32 g~%int32 b~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'led_msg)))
  "Returns full string definition for message of type 'led_msg"
  (cl:format cl:nil "int32 occupied_channel~%int32 r~%int32 g~%int32 b~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <led_msg>))
  ...
  (cl:list 'led_msg
    (cl:cons ':occupied_channel (occupied_channel msg))
    (cl:cons ':r (r msg))
    (cl:cons ':g (g msg))
    (cl:cons ':b (b msg))
))
